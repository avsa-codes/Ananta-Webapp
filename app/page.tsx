    ...
    <div className="min-h-screen bg-[#faf7f2]">
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-[#3b2a20] leading-tight">
            Preserve Culture.
            <span className="text-[#b5533c]"> Empower Artisans.</span>
            <br />
            Share Meaningful Gifts.
          </h1>

          <p className="mt-6 text-lg text-gray-600 max-w-2xl mx-auto">
            Discover handcrafted products from NGOs and artisan communities across India.
            Perfect for personal purchases and impact-driven corporate gifting.
          </p>

          <div className="flex justify-center gap-4 mt-8">
            <Button className="bg-[#b5533c] hover:bg-[#a34833] text-white px-6 py-5 text-lg">
              Explore Marketplace
            </Button>

            <Button
              variant="outline"
              className="px-6 py-5 text-lg border-[#cbb8a6]"
            >
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
          ...
          <div className="text-center">
            <img
              src="/images/impact-wellness-box.png"
              className="rounded-xl shadow-sm"
            />

            <h3 className="text-2xl font-serif mt-6 text-[#3b2a20]">
              Impact Wellness Box
            </h3>

            <p className="text-gray-600 mt-3 text-sm px-4">
              Includes artisan wellness products sourced from NGOs supporting
              social impact initiatives.
            </p>

            <Button
              variant="outline"
              className="mt-4 border-[#cbb8a6]"
            >
              Request Quote
            </Button>
          </div>
          ...
          <div className="text-center">
            <img
              src="/images/microgreen-wellness-box.png"
              className="rounded-xl shadow-sm"
            />

            <h3 className="text-2xl font-serif mt-6 text-[#3b2a20]">
              Microgreen Wellness Box
            </h3>

            <p className="text-gray-600 mt-3 text-sm px-4">
              Includes a microgreen grow kit along with handcrafted wellness
              products curated for mindful gifting.
            </p>
          ...
          <div className="text-center">
            <img
              src="/images/premium-desk-gift-box.png"
              className="rounded-xl shadow-sm"
            />

            <h3 className="text-2xl font-serif mt-6 text-[#3b2a20]">
              Premium Desk Gift Box
            </h3>

            <p className="text-gray-600 mt-3 text-sm px-4">
              Elegant handcrafted desk accessories and artisan goods designed
              for thoughtful corporate gifting.
            </p>
      ...
      <section className="py-20 px-6 text-center">
        ...
        <h2 className="text-4xl font-serif font-bold text-[#3b2a20]">
          Explore Artisan & Natural Products
        </h2>

        <p className="text-gray-600 mt-3">
          Discover the inspiring stories behind our handcrafted products.
        </p>
        ...
        <div className="max-w-7xl mx-auto mt-12 grid md:grid-cols-4 gap-6">
          ...
          <div>
            <img
              src="/images/mosaic-coasters.png"
              className="rounded-xl"
            />
            <p className="mt-3 font-medium text-[#3b2a20]">
              Tessarae Mosaic Coasters
            </p>
          </div>

          <div>
            <img
              src="/images/microgreen-grow-kit.png"
              className="rounded-xl"
            />
            <p className="mt-3 font-medium text-[#3b2a20]">
              Microgreen Grow Kit
          ...
          <div>
            <img
              src="/images/himalayan-honey.png"
              className="rounded-xl"
            />
            <p className="mt-3 font-medium text-[#3b2a20]">
              Himalayan Honey
        ...
        <Button className="mt-10 bg-[#b5533c] hover:bg-[#a34833] text-white px-6 py-5 text-lg">
          Shop Marketplace
        </Button>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          {/* MAKERS */}
          <div className="bg-[#f2e9e2] rounded-2xl p-10">
            <h3 className="text-3xl font-serif text-[#3b2a20]">
              Meet the Makers
            </h3>
            ...
            <ul className="mt-6 space-y-2 text-gray-700">
              <li>• Gift boxes for all occasions</li>
              <li>• Custom branding & packaging</li>
              <li>• Supporting social impact</li>
            </ul>

            <Button
              variant="outline"
              className="mt-6 border-[#cbb8a6]"
            >
              Get a Custom Quote
            </Button>
          </div>
          ...
          <div className="bg-white rounded-2xl border p-10 text-center">
            ...
            <div className="flex items-center justify-center gap-16">
              ...
              <img
                src="/images/ananta-logo.png"
                className="h-16 object-contain"
              />

              <img
                src="/images/homes-and-hills-logo.png"
                className="h-16 object-contain"
              />
      ...
      {/* FOOTER */}
      <footer className="text-center py-10 border-t mt-10 text-gray-600">
        ...
        <p className="text-sm">
          © 2026 Ananta. Preserving culture, one story at a time.
        </p>
